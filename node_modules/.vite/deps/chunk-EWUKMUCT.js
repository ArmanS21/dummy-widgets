        ...
        if (f3) {
          if (Gn.includes(f3.type))
            if ("inherit" === f3.background || "inherit" === f3.color) {
              ...
              (0, import_set.default)(r4, s4, "url(#" + l4 + ")");
...
var X = function(i3) {
  var n3, l3, a3, d3, g3, f3, m4, v4, u3, y4, k4, x4 = i3.x, b3 = i3.y, A3 = i3.width, W2 = i3.height, z3 = i3.data, C4 = i3.direction, X2 = void 0 === C4 ? "left-to-right" : C4, Y2 = i3.justify, O4 = void 0 !== Y2 && Y2, B3 = i3.textColor, H2 = i3.background, E3 = void 0 === H2 ? "transparent" : H2, j2 = i3.opacity, L = void 0 === j2 ? 1 : j2, M2 = i3.symbolShape, F2 = void 0 === M2 ? "square" : M2, T2 = i3.symbolSize, P2 = void 0 === T2 ? 16 : T2, V2 = i3.symbolSpacing, R = void 0 === V2 ? 8 : V2, D2 = i3.symbolBorderWidth, q2 = void 0 === D2 ? 0 : D2, G = i3.symbolBorderColor, I = void 0 === G ? "transparent" : G, N2 = i3.onClick, _ = i3.onMouseEnter, J = i3.onMouseLeave, K2 = i3.toggleSerie, Q = i3.effects, U = (0, import_react18.useState)({}), Z = U[0], $ = U[1], tt2 = zt(), et2 = (0, import_react18.useCallback)(function(t6) {
    ...
    null == J || J(z3, t6);
  }, [J, z3, Q]), nt2 = S({ direction: X2, justify: O4, symbolSize: null != (n3 = Z.symbolSize) ? n3 : P2, symbolSpacing: R, width: A3, height: W2 }), ot2 = nt2.symbolX, rt2 = nt2.symbolY, lt = nt2.labelX, at2 = nt2.labelY, ct2 = nt2.labelAnchor, dt2 = nt2.labelAlignment, st = [N2, _, J, K2].some(function(t6) {
    return void 0 !== t6;
  ...
  }, onMouseEnter: et2, onMouseLeave: it2 }), c8.createElement(ht2, p2({ id: z3.id, x: ot2, y: rt2, size: null != (d3 = Z.symbolSize) ? d3 : P2, fill: null != (g3 = null != (f3 = z3.fill) ? f3 : z3.color) ? g3 : "black", borderWidth: null != (m4 = Z.symbolBorderWidth) ? m4 : q2, borderColor: null != (v4 = Z.symbolBorderColor) ? v4 : I }, z3.hidden ? tt2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime3.jsx)("text", { textAnchor: ct2, style: p2({}, Mt(tt2.legends.text), { fill: null != (u3 = null != (y4 = null != (k4 = Z.itemTextColor) ? k4 : B3) ? y4 : tt2.legends.text.fill) ? u3 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, z3.hidden ? tt2.legends.hidden.text : void 0), x: lt, y: at2, children: z3.label })] });
};
var Y = function(e6) {
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-EWUKMUCT.js.map
